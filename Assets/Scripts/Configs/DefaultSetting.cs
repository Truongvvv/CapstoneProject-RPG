...
public class DefaultSetting : ScriptableObject
{
    ...
    public float masterInitVolume = 1.0f;
    ...
    [Header("🎮 Control Settings")] [Range(0.1f, 10f)]
    ...
    [Header("⚔️ Gameplay Settings")] public Difficulty difficulty = Difficulty.Normal;
    ...
    [Header("🌍 Language & Region")] public Language language = Language.English;
