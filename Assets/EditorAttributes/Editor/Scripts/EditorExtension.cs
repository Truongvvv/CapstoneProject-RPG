...
namespace EditorAttributes.Editor
{
    ...
    public class EditorExtension : UnityEditor.Editor
    {
        ...
        protected VisualElement DrawNonSerilizedMembers()
        {
            ...
            var nonSerializedFields = target.GetType().GetFields(ReflectionUtility.BINDING_FLAGS)
            ...
            var nonSerializedProperties = target.GetType().GetProperties(ReflectionUtility.BINDING_FLAGS)
                .Where((field) => field.GetCustomAttribute<ShowInInspectorAttribute>() != null);
            ...
            var nonSerializedMethods = target.GetType().GetMethods(ReflectionUtility.BINDING_FLAGS)
                .Where((field) => field.GetCustomAttribute<ShowInInspectorAttribute>() != null);
