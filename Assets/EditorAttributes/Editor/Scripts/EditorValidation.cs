...
namespace EditorAttributes.Editor
{
    ...
    public class EditorValidation : IPreprocessBuildWithReport
    {
        ...
        public static void Validate(Object targetObject, ref int failedValidations, ref int successfulValidations)
        {
            ...
            foreach (var field in fields)
            {
                ...
                if (validateAttribute != null)
                {
                    ...
                    {
                        string customMessage = customCheck == null
                            ? validateAttribute.ValidationMessage
                            : customCheck.ValidationMessage;
                        bool isBuildKiller =
            ...
            out ValidationCheck customValidationCheck)
        {
            ...
            {
                if (ReflectionUtility.GetMemberInfoValue(memberInfo, targetObject) is not ValidationCheck
                    memberInfoValue)
                    return false;
