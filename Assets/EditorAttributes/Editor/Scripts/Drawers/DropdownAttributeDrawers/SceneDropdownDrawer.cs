    ...
    public class SceneDropdownDrawer : PropertyDrawerBase
    {
        public override VisualElement CreatePropertyGUI(SerializedProperty property)
        {
                ...
                property.propertyType == SerializedPropertyType.Integer)
            {
                ...
                {
                    string sceneName = trackedProperty.propertyType == SerializedPropertyType.Integer
                    ...
                    {
                        Debug.LogWarning(
                            $"The value <b>{trackedProperty.boxedValue}</b> set to the <b>{trackedProperty.name}</b> variable is not a valid scene identifier.",
