...
namespace EditorAttributes.Editor
{
    ...
    public class SelectionButtonsDrawer : PropertyDrawerBase
    {
        public override VisualElement CreatePropertyGUI(SerializedProperty property)
        {
            ...
            if (property.propertyType == SerializedPropertyType.Enum)
            {
                ...
                if (isFlagsEnum)
                {
                    ...
                    root.Add(DrawEnumFlagButtons(flagValue, property.enumDisplayNames, property,
                        selectionButtonsAttribute, (value) =>
                        {
                ...
                else
                {
                    ...
                    root.Add(DrawButtons(buttonsValue, property.enumDisplayNames, property, selectionButtonsAttribute,
                        (value) =>
                        {
        ...
        private VisualElement DrawButtons(int buttonsValue, string[] valueLabels, SerializedProperty property,
        ...
        private VisualElement DrawEnumFlagButtons(int flagValue, string[] valueLabels, SerializedProperty property,
            SelectionButtonsAttribute selectionButtonsAttribute, Action<int> onValueChanged)
        {
            var toolbar = new OverlayToolbar();
            toolbar.style.flexDirection = FlexDirection.Row;
