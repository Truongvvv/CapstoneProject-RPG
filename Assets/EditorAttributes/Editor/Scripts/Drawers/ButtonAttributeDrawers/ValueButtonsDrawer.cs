    ...
    public class ValueButtonsDrawer : PropertyDrawerBase
    {
        ...
        public override VisualElement CreatePropertyGUI(SerializedProperty property)
        {
            ...
            string[] propertyValues =
                ConvertCollectionValuesToStrings(valueButtonsAttribute.CollectionName, property, collectionInfo,
                    errorBox).ToArray();
            string[] displayValues =
                GetDisplayValues(collectionInfo, valueButtonsAttribute, property, propertyValues.ToList());
            ...
            valueButtons.TrackPropertyValue(property, (trackedProperty) =>
            {
                ...
                {
                    Debug.LogWarning(
                        $"The value <b>{trackedProperty.boxedValue}</b> set to the <b>{trackedProperty.name}</b> variable is not a value available in the button selection",
        ...
        private ToggleButtonGroup DrawButtons(int buttonsValue, string[] valueLabels,
        ...
        private string[] GetDisplayValues(MemberInfo collectionInfo, ValueButtonsAttribute valueButtonsAttribute,
