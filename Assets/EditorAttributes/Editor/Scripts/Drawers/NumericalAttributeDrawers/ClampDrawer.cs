                    ...
                    case SerializedPropertyType.Float:
                        switch (property.numericType)
                        {
                            case SerializedPropertyNumericType.Float:
                                property.floatValue = Mathf.Clamp(property.floatValue, minMaxX.MinValueX,
                                    minMaxX.MaxValueX);
                                propertyField.Q<FloatField>().SetValueWithoutNotify(property.floatValue);
                                break;

                            case SerializedPropertyNumericType.Double:
                                property.doubleValue = Mathf.Clamp((float)property.doubleValue, minMaxX.MinValueX,
                                    minMaxX.MaxValueX);
