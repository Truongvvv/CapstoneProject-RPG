                    ...
                    case SerializedPropertyType.Integer:
                        switch (property.numericType)
                        {
                            ...
                            case SerializedPropertyNumericType.UInt32:
                                property.uintValue = (uint)Wrap(property.uintValue, minMaxX.MinValueX,
                                    minMaxX.MaxValueX);
                                propertyField.Q<UnsignedIntegerField>().SetValueWithoutNotify(property.uintValue);
                                break;

                            case SerializedPropertyNumericType.Int64:
                                property.longValue = (long)Wrap(property.longValue, minMaxX.MinValueX,
                                    minMaxX.MaxValueX);
                                propertyField.Q<LongField>().SetValueWithoutNotify(property.longValue);
                                break;

                            case SerializedPropertyNumericType.UInt64:
                                property.ulongValue = (ulong)Wrap(property.ulongValue, minMaxX.MinValueX,
                                    minMaxX.MaxValueX);
                    ...
                    case SerializedPropertyType.Float:
                        switch (property.numericType)
                        {
                            ...
                            case SerializedPropertyNumericType.Double:
                                property.doubleValue = Wrap((float)property.doubleValue, minMaxX.MinValueX,
                                    minMaxX.MaxValueX);
