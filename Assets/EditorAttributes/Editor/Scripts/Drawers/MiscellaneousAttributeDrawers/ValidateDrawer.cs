...
namespace EditorAttributes.Editor
{
    ...
    public class ValidateDrawer : PropertyDrawerBase
    {
            ...
            SerializedProperty serializedProperty, HelpBox helpBox, HelpBox errorBox)
        {
            ...
            {
                if (ReflectionUtility.GetMemberInfoValue(memberInfo, serializedProperty) is not ValidationCheck
                    memberInfoValue)
                    return false;
            ...
            errorBox.text =
                $"The provided condition \"{validateAttribute.ConditionName}\" is not a valid boolean or ValidationCheck type";
