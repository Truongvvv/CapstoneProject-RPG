...
namespace EditorAttributes.Editor
{
    ...
    public class AssetPreviewDrawer : PropertyDrawerBase
    {
        ...
        private void GetAssetPreview(SerializedProperty property, AssetPreviewAttribute assetPreviewAttribute,
            VisualElement root, Image image)
        {
            ...
            while (texture == null && attempts < 3)
            {
                ...
                Thread.Sleep(
                    20); // Suspend the main thread for a bit to give time for the asset preview to load since is doing it asynchronously
            }
