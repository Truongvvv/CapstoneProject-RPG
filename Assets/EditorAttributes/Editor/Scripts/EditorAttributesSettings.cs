...
namespace EditorAttributes.Editor
{
    ...
    internal class EditorAttributesSettings : ScriptableSingleton<EditorAttributesSettings>
    {
        ...
        [Space] [SerializeField, DataTable] internal UnitDefinition[] customUnitDefinitions;

        [MessageBox(nameof(messageBoxText), nameof(CheckValidUnitDefinitions), MessageMode.Warning,
    ...
    internal class EditorAttributesSettingsProvider : SettingsProvider
    {
        ...
        public override void OnActivate(string searchContext, VisualElement rootElement)
        {
                    ...
                    "https://editorattributesdocs.readthedocs.io/en/latest/GettingStarted/editorattributessettings.html"))
            {
                ...
                style =
                {
                    borderTopLeftRadius = 0f, borderTopRightRadius = 0f, borderBottomLeftRadius = 0f,
            ...
            helpButton.RegisterCallback<MouseOverEvent>((callack) =>
                helpButton.style.backgroundColor = new Color(0.3f, 0.3f, 0.3f, 1f));
            ...
            var disableBuildValidationPropertyField =
                PropertyDrawerBase.CreatePropertyField(serializedObject.FindProperty("disableBuildValidation"));

            disableBuildValidationPropertyField.tooltip = "Disables automatic validation when building the project";

            var customUnitDefinitionsPropertyField =
                PropertyDrawerBase.CreatePropertyField(serializedObject.FindProperty("customUnitDefinitions"));
            ...
            var messageBoxHolderPropertyField =
                PropertyDrawerBase.CreatePropertyField(serializedObject.FindProperty("messageBoxHolder"));
