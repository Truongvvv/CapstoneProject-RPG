...
namespace EditorAttributesSamples
{
    ...
    public class TabGroupSample : MonoBehaviour
    {
        ...
        [VerticalGroup(nameof(intField01), nameof(intField02))] [SerializeField, HideProperty]
        ...
        [VerticalGroup(true, nameof(boolField01), nameof(boolField02))] [SerializeField, HideProperty]
