...
namespace EditorAttributesSamples
{
    ...
    {
        [Header("InlineButton Attribute:")] [InlineButton(nameof(PrintString))] [SerializeField]
        private string stringField;

        [InlineButton(nameof(AddValue), true, buttonLabel: "Hold to add +10", buttonWidth: 200f)] [SerializeField]
        private int intField;

        [InlineButton(nameof(DecreaseFloat), "-", 20f), InlineButton(nameof(IncreaseFloat), "+", 20f)] [SerializeField]
