...
namespace EditorAttributesSamples
{
    ...
    {
        [Header("DrawHandle Attribute:")] [SerializeField, DrawHandle]
        private float floatField;

        [Space] [SerializeField, DrawHandle(handleSpace: Space.Self)]
        private Vector3[] vector3Array;

        [SerializeField, DrawHandle] private SimpleTransform transformField;

        [Space] [SerializeField, DrawHandle(GUIColor.Green, Space.Self)]
