...
{
    [HelpURL(
        "https://editorattributesdocs.readthedocs.io/en/latest/Attributes/MiscellaneousAttributes/showininspector.html")]
    public class ShowInInspectorSample : MonoBehaviour
    {
        [Header("ShowInInspector Attribute:")] [SerializeField]
        private Void headerHolder;
