...
namespace EditorAttributesSamples
{
    ...
    {
        [Header("Title Attribute:")] [Title("This is a title!")] [SerializeField]
        private int intField01;

        [SerializeField] private string stringField01;
        [SerializeField] private float floatField01;

        [Title("<b>Big bold title!</b>", 40, lineThickness: 4f, alignment: TextAnchor.MiddleRight)] [SerializeField]
        ...
        [Title(nameof(DynamicTitle), 20, 10f, true, stringInputMode: StringInputMode.Dynamic)] [SerializeField]
